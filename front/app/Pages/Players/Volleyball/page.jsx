        ...
        <div className="min-h-screen bg-background text-foreground" dir="rtl">
            ...
            <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0 scale-110">
                    <Image
                        src="/squads/vollyzsc.png"
                        alt="الكرة الطائرة نادي الزمالك"
                        fill
                ...
                <div className="container mx-auto px-4 flex justify-center gap-6">
                    {['Roster', 'Coaching', 'History'].map(tab => (
                        <button
                            ...
                            className={`px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-blue-500 text-foreground shadow-xl shadow-blue-500/20' : 'hover:bg-muted opacity-40 hover:opacity-100'
                                }`}
                        >
...
function InfoCard({ label, value, icon, color }) {
    return (
        <div className="p-12 bg-card border border-border rounded-[3rem] shadow-xl flex items-center gap-8 group hover:border-blue-500 transition-all">
            <div className={`w-16 h-16 rounded-2xl bg-muted flex items-center justify-center ${color} group-hover:bg-blue-500 group-hover:text-foreground transition-all`}>
                {icon}
            </div>
            <div>
